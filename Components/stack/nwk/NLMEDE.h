...
// ***********************   BROADCAST SUPPORT  **********************************
// π„≤•µÿ÷∑∂®“Â(Broadcast address definitions)
...
enum  bcast_addr_e {
  ...
  NWK_BROADCAST_SHORTADDR_DEVZCZR,            	///< 0xFFFC: À˘”–¬∑”…∆˜∫Õ–≠µ˜∆˜(Routers and Coordinators)
  NWK_BROADCAST_SHORTADDR_DEVRXON,            	///< 0xFFFD: À˘”–¥¶”⁄IDLE◊¥Ã¨œ¬µƒ…Ë±∏(Everyone with RxOnWhenIdle == TRUE)
                                              	///< 0xFFFE: ±£¡Ù(Reserved (legacy: used for 'invalid address'))
  NWK_BROADCAST_SHORTADDR_DEVALL     = 0xFFFF	///< π„≤•,∑¢ÀÕµΩÀ˘”–…Ë±∏(∞¸¿®–›√ﬂµƒ),∂‘”⁄–›√ﬂµƒ,–≈œ¢±ª±£¥Ê‘⁄À¸µƒ∏∏Ω⁄µ„,÷±µΩ–›√ﬂΩ· ¯Ω” ’/timeout(”…f8wConfig.cfg÷–NWK_INDIRECT_MSG_TIMEOUT÷∏∂®)
};
